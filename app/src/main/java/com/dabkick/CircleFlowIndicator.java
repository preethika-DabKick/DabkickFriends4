...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	private float mRadiusInactive = 50;
	private float mRadiusActive =50;
	...
	public CircleFlowIndicator(Context context) {
		super(context);
		initColors(0xFF000000, 0xFF000000, STYLE_FILL, STYLE_STROKE);
	}
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		// Retrieve the radius
		mRadius = a.getDimension(R.styleable.CircleFlowIndicator_radius, 4.5f);
