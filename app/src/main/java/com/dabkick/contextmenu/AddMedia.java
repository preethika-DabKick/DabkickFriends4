...
public class AddMedia extends Activity{
	...
	RelativeLayout photos,music, videos, cancel, my_layout,background;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		photos.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				setResult(Utils.RESULT_CODE_PHOTOS);
				finish();
			}
		});
		...
		videos.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				setResult(Utils.RESULT_CODE_VIDEOS);
				finish();
			}
		});
		...
		music.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				setResult(Utils.RESULT_CODE_MUSIC);
				finish();
			}
		});
	...
	private void init() {
		photos = (RelativeLayout) findViewById(R.id.add_photos_layout);
		videos = (RelativeLayout) findViewById(R.id.add_videos_layout);
		music = (RelativeLayout) findViewById(R.id.add_music_layout);
